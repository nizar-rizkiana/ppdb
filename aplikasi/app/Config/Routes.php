...
$routes->get('/peserta-baru', 'Admin\Peserta::pesertabaru', ['filter' => 'adminFilter']);
$routes->get('/update/(:num)', 'Admin\Peserta::update/$1', ['filter' => 'adminFilter']);
$routes->post('/peserta/editPeserta/(:num)', 'Admin\Peserta::editPeserta/$1', ['filter' => 'adminFilter']);
$routes->post('/peserta/editBerkas/(:num)', 'Admin\Peserta::editBerkas/$1', ['filter' => 'adminFilter']);
