...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="row">
            <table class="table table-striped" id="table-baru">
                <thead>
                <tr>
                    <th scope="col">No</th>
                ...
                <tr>
                    ...
                    <div class="modal fade" id="modalDetail<?= $p['id_peserta'] ?>" tabindex="-1" aria-labelledby="modalDetailLabel<?= $p['id_peserta'] ?>" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <?= form_open('/peserta/editPeserta/'.$p['id_peserta'], ['enctype' => 'multipart/form-data']) ?>
                            <?php csrf_token() ?>
                            <div class="modal-body">
                                ...
                                <tr>
                                <td colspan="3">Status Pendaftaran Anda : <span class="badge bg-primary">Proses</span></td>
                                </tr>
                            </table>
                            </div>
                        ...
                        <form action="<?= base_url() ?>/admin/peserta/update/<?= $p['id_peserta']; ?>" method="post" class="d-inline">
                            ...
                            <button type="submit" class="btn btn-success" onclick="return confirm('Apakah Anda Yakin, lanjut seleksi berkas?');">
                            <svg class="icon">
                        ...
                        <form action="<?= base_url() ?>/admin/peserta/update/<?= $p['id_peserta']; ?>" method="post" class="d-inline">
                            ...
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin, menolak peserta ini?');">
                            <svg class="icon">
